...
@NonCPS
create(String team_name, String orgname){
...
def projectId = resultJson.id
	sh """
            curl --location --request POST 'https://dev.azure.com/${orgname}/_apis/projects/${projectId}/teams?api-version=5.1' \
