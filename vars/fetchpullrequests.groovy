...
String projectName=b.replaceAll("\\[", "").replaceAll("\\]","");
   ...
   sh """ 
curl --request GET 'https://dev.azure.com/${orgname}/${projectName}/_apis/git/pullrequests?timeRange=14/02/2020%2011:00~14/02/2020%2012:00&timeUnit=day&api-version=5.1' \
