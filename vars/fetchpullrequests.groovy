...
String projectName=b.replaceAll("\\[", "").replaceAll("\\]","");
   ...
   sh """ 
curl --request GET 'https://dev.azure.com/${orgname}/${projectName}/_apis/git/pullrequests?timeRange=12/02/2020+11:00~12/02/2020+22:00&timeUnit=day&api-version=5.1' \
