...
String projectName=b.replaceAll("\\[", "").replaceAll("\\]","");
   ...
   sh """ 
curl --request GET 'https://dev.azure.com/${orgname}/${projectName}/_apis/git/pullrequests?timeRange=14/02/2020+11:00~14/02/2020+12:00&timeUnit=day&api-version=5.1' \
